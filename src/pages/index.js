...
export default function Home() {
  return (
    <>
      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:tex-light">
            ...
            <div className="w-1/2 flex flex-col items-center self-center">
              ...
              <div className="flex items-center self-start mt-2">
                ...
                <Link
                  ...
                  target={"_blank"}
                  className="ml-4 textlg font-medium capitalize text-dark underline dark:text-light"
                >
                  Contact
                </Link>
              </div>
